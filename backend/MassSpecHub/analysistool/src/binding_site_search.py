...
if __name__ == "__main__":
    ...
    bound = os.path.join(os.path.dirname(path), "example\\bound_spectrum.xlsx")
    adducts = os.path.join(os.path.dirname(path), "example\\adducts.xlsx")
    compounds = os.path.join(os.path.dirname(path), "example\compounds.xlsx")
    #compounds = "adducthunter-main/example/compounds.xlsx"
    #adducts = "adducthunter-main/example/compounds.xlsx"
    #bound = "example/bound_spectrum.xlsx"
