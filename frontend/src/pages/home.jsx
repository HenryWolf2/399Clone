...
export default function Home() {
  ...
  return (
    <div class="container">
      <NavigationBar />
      <h1 class= "landing-title"> Welcome to Mass Spec Hub </h1>
      ...
      <div style={{height: '85px', backgroundColor:'#02AEEC', display:'flex'}}>
          <div style={{flex:1, flexDirection: 'row', borderRight: '1px solid grey', height: '100%', boxShadow: '0px 5px 5px rgba(0, 0, 0, 0.2)',}}>
            <h1 style={{textAlign: 'center', color:'white', }}>Trending Posts</h1>
          </div>
          <div style={{flex:1, flexDirection: 'row', height: '100%', boxShadow: '0px 5px 5px rgba(0, 0, 0, 0.2)',}}>
            <h1 style={{textAlign: 'center', color:'white', paddingBottom:'10px'}}>Infomation</h1>
          </div>
      </div>
      <div style= {{height: "450px"}}>
        ...
        <div style={{ display: 'flex', flexDirection: 'row', height: '100%' }}>
          ...
          <div style= {{flex: 1}}>
          <div class= "landing-desc-box">
            <p class='landingText'>Collaboration and data sharing are at the heart of our platform. By creating profiles, researchers can connect with like-minded individuals, form research groups, and share their analyzed data securely. Imagine the possibilities of collaborating with experts from different fields, pooling your knowledge, and collectively advancing research in mass spectrometry. Our platform facilitates this collaboration, fostering new ideas and driving innovation.</p>
          </div>
          </div>
        </div>
      </div>
